...
repeat
 ok=true
 r = Math.Rand(0,19) -- Which one shall we pick today?
 ...
 rtimeout = rtimeout + 1 if rtimeout>200000 and (not ok) then Sys.Error('Random Encounter Timeout','Enounterlist,busheswest') end
until ok
