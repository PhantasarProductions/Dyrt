...
repeat
 ...
 if r==12 then
     ...
     ret.Enemy2 = 'Wolf'
     ret.Migrant = ret.Migrant + 8
     ret.Enemy3 = 'HellHound'
     ret.Migrant = ret.Migrant + 22
     ret.Enemy4 = 'Wolf'
     ret.Migrant = ret.Migrant + 8
     ret.Enemy5 = 'HellHound'
     ret.Migrant = ret.Migrant + 22
     ret.Enemy6 = 'Wolf'
     ret.Migrant = ret.Migrant + 8
     ret.Enemy7 = 'HellHound'
     ret.Migrant = ret.Migrant + 22
     ret.Enemy8 = 'Wolf'
     ret.Migrant = ret.Migrant + 8
     ret.Enemy9 = 'HellHound'
     ret.Migrant = ret.Migrant + 22
     s = Sys.Val(Var.C('%SKILL'))
     if s==1 then ok=false end
     ret.Initiative = -1
 ...
 rtimeout = rtimeout + 1 if rtimeout>200000 and (not ok) then Sys.Error('Random Encounter Timeout','Enounterlist,Storage_Rondomo') end
until ok
