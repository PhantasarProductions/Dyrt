...
repeat
 ok=true
 r = Math.Rand(0,9) -- Which one shall we pick today?
 ...
 if r==0 then
     ret.Migrant=0
     ret.Enemy1 = 'DarkServant'
     ret.Migrant = ret.Migrant + 40
 ...
 rtimeout = rtimeout + 1 if rtimeout>200000 and (not ok) then Sys.Error('Random Encounter Timeout','Enounterlist,Dyrt_village') end
until ok
