...
repeat
 ...
 if r==3 then
     ...
     ret.Migrant = ret.Migrant + 5
     ret.Enemy5 = 'GreenSlime'
     ret.Migrant = ret.Migrant + 5
     ret.Enemy6 = 'GreenSlime'
     ret.Migrant = ret.Migrant + 5
     s = Sys.Val(Var.C('%SKILL'))
 ...
 if r==4 then
     ...
     ret.Enemy6 = 'GreenSlime'
     ret.Migrant = ret.Migrant + 5
     ret.Enemy7 = 'GreenSlime'
     ret.Migrant = ret.Migrant + 5
     ret.Enemy8 = 'GreenSlime'
     ret.Migrant = ret.Migrant + 5
     ret.Enemy9 = 'GreenSlime'
     ret.Migrant = ret.Migrant + 5
     s = Sys.Val(Var.C('%SKILL'))
     if s==1 then ok=false end
 ...
 if r==10 then
     ret.Migrant=0
     ret.Enemy1 = 'GreenGhost'
     ret.Migrant = ret.Migrant + 7
     s = Sys.Val(Var.C('%SKILL'))
     ret.Initiative = -1
     end
 -- Encounter #11
 ...
 rtimeout = rtimeout + 1 if rtimeout>200000 and (not ok) then Sys.Error('Random Encounter Timeout','Enounterlist,greendragon') end
until ok
