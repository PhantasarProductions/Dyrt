...
-- --@USE /GALE/QuickData.lua

-- @USEDIR GALE/

-- I'm too lazy to make the GALE dir included in each file separately and as I had to use the Units dir anyway, this will now include the GALE files automatically. 
